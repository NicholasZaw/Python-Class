...
pygame.display.set_caption("Nick's Game")
...
class player(object):
    ...
    def draw(self, win):
        ...
        if not(self.standing):
            ...
            pygame.draw.rect(win, (0,0,0), (self.hitbox[0], self.hitbox[1] - 20, 80, 10))
...
class enemy(object):
    ...
    def draw(self,win):
        ...
        if self.visible:
            ...
            pygame.draw.rect(win, (255,0,0), (self.hitbox[0], self.hitbox[1] - 20, 80, 10))
...
def winnn():
    win.blit(bg, (0,0))
    text = font.render('You have Won!', 1, (128,0,0))
    win.blit(text, (170, 100))
    man.draw(win)
    goblin.draw(win)
    textt = font.render('Score: ' + str(score), 1, (0,0,0))
    win.blit(textt, (350, 10))

    pygame.display.update()
    
def loseee():
    win.blit(bg, (0,0))
    text = font.render('You have Lost!', 1, (128,0,0))
    win.blit(text, (170, 100))
    textt = font.render('Score: ' + str(score), 1, (0,0,0))
    win.blit(textt, (350, 10))
...
# 	update_rect = win.Rect(30,30,250,200)
# 	losingfont = pygame.font.SysFont('comicsans',100)
# 	losingtext = losingfont.render('You Have Lost', 1, (255, 0, 0))
# 	win.blit(losingtext, (250 - (text.get_width()/2, 200) )
